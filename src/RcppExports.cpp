...
// choose_cells_cpp
List choose_cells_cpp(arma::mat X, arma::mat D, bool exclusive, arma::uvec grps, arma::uvec s, double nu, double kappa, double resolution, arma::vec betas, int n_steps, int family, arma::uvec Ds_parameters, double ar1_rho, int t, double s2rf, unsigned int report_every, double max_dist, bool report_candidates, double temperature_alpha, bool use_frozen_grps, unsigned int unfrozen_grps, double s2e);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< unsigned int >::type unfrozen_grps(unfrozen_grpsSEXP);
