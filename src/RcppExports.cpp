...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< unsigned int >::type max_grp_size_for_weight_matrix(max_grp_size_for_weight_matrixSEXP);
    rcpp_result_gen = Rcpp::wrap(choose_cells_cpp(X, D, exclusive, grps, s, nu, kappa, resolution, betas, n_steps, family, Ds_parameters, ar1_rho, t, s2rf, report_every, max_dist, report_candidates, temperature_alpha, use_frozen_grps, unfrozen_grps, s2e, max_grp_size_for_weight_matrix));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_saoptimality_choose_cells_cpp", (DL_FUNC) &_saoptimality_choose_cells_cpp, 23},
    {NULL, NULL, 0}
};
